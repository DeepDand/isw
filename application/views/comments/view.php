...
<?php foreach ($comment_query->result() as $comment_result) : ?>
  <li class="media">
    ...
    <div class="media-body">
      <h4 class="media-heading"><?php echo $comment_result->usr_name . base_url().'comments/flag/'.$comment_result->ds_id . '/' . $comment_result->cm_id,$this->lang->line('comments_flag') ; ?></h4>
