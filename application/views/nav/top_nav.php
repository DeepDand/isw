  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse collapse">
     <ul class="nav navbar-nav">
       ...
       <li <?php if ($this->uri->segment(1) == 'New Discussion') {echo 'class="active"';} ; ?>><?php echo anchor('c=Discussions&m=create', $this->lang->line('top_nav_new_discussion')) ; ?></li>
     </ul>

     <ul class="nav navbar-nav navbar-right">
       <!--<li><?php //echo anchor('admin/login', $this->lang->line('top_nav_login')) ; ?></li>-->
       <li><?php echo anchor('c=Discussions&m=open_login', 'Login') ; ?></li>
     </ul>
   </div><!--/.nav-collapse -->
  </div>
</div>
